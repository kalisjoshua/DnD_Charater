...
prv.tables = {
    saves: {
        get: function (className, level) {
            return this[className][level].split(" ");
        },
	    ...
	    Archer      : this.Cleric,
	    Assassin    : this.Thief,
	    Barbarian   : this.Fighter,
	    Bard        : this.Fighter,
	    Cavalier    : this.Fighter,
	    Illusionist : this.Mage,
	    Monk        : this.Thief,
	    Paladin     : this.Fighter,
	    Ranger      : this.Fighter
    },
    
    thaco: {
        get: function(className, level) {
            return this[className].split(" ")[level];
        },
