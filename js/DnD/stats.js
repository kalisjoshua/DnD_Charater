...
prv.stats = {
    ...
    lookup: function (stat, v, e) {
        if (prv.util.isArray(v)) {
            e = v[1];
            v = v[0];
        }
        
        if (!v || v < 3 || v > 24 || (!!e && (e < 0 || e > 100))) {
            return false;
        }
        
        return (!!e && stat === "str") ? prv.stats.tables.str_(e) : prv.stats.tables["_" + stat][v];
    },
    
    matrix: function (json) {
        if (!prv.util.isObject(json)) {
            return false;
        }
        
        var a = "",
            b = prv.stats.abilities,
            result = {};
            
        for (a in b) {
            result[b[a]] = prv.stats.lookup(b[a], json[b[a]]);
        }
    ...
    tables: {
    	...
    	str_: function (e) {
            // e = 0 is the same as e = 100 because "00" is not possible as an integer
    	    e = (e === 0) ? 100 : e;
