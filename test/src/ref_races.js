...
test("ref_races.js", function () {
    ...
    while (test_obj.length) {
        ...
        ok(Reference.Races[test_obj[0]].abilities.length === 8, test_obj[0] + ".abilities.length is 8");
        ...
        ok(Reference.Races[test_obj[0]].stats.length === 7, test_obj[0] + ".stats.length is 7");
